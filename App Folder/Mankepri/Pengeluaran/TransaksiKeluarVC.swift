...
class TransaksiKeluarVC: UIViewController, UITextFieldDelegate {
    ...
    let kategori = ["Konsumsi", "Belanja Umum", "Belanja Online", "Transportasi", "Lain-Lain"]
    ...
    //MARK: - tombol tambah
    @IBAction func tomboltambahpengeluaran(_ sender: Any) {
    ...
    //MARK: - tombol dropdown func
    @IBAction func tomboldropdownaction(_ sender: Any) {
        dropDown.show()
    }
    
    //MARK: - Membatasi text field keterangan sampai 40 karakter
    ...
    func peringatansimpan(){
        ...
        alert.addAction(UIAlertAction(title: "Simpan", style: .default, handler: { ACTION in
            ...
            let insert = "INSERT INTO transaksi (uang, kategori, keterangan, tanggal, jenis) VALUES (?, ?, ?, ?, 'DB')"
